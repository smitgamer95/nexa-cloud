...
export default function NewPasswordPage() {
  ...
  return (
    <AuthLayout title="Set new password" subtitle="Your new password must be at least 8 characters">
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="space-y-2">
          <Label htmlFor="password" className="text-sm font-normal text-muted-foreground">New password</Label>
        ...
        <div className="space-y-2">
          <Label htmlFor="confirm" className="text-sm font-normal text-muted-foreground">Confirm new password</Label>
          <div className="relative">
            <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
            <Input
              id="confirm"
